...
Local-testable MBBS doctor appointment, patient-management and prescription PWA. The current build uses browser-local demo data and mock SMS notices. Start with [LOCAL_SETUP.md](./LOCAL_SETUP.md).
