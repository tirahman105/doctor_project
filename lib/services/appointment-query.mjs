...
export const appointmentSelection =
  "id,starts_at,ends_at,consultation_type,fee_bdt,status,slot_id,patients!appointments_patient_id_fkey(id,full_name,patient_contacts!patient_contacts_patient_id_fkey(phone,is_primary)),payments!payments_appointment_id_fkey(status)";
